...
TEST(arvbin_visitar_em_ordem_inversa, ArvoreVazia)
{
	struct arvbin arv;
	...
	arvbin_visitar_em_ordem_inversa(&arv, func_visita);

	aux_arvbin_limpar(&arv);
}

TEST(arvbin_visitar_em_ordem_inversa, ArvoreUmElemento)
{
	struct arvbin arv;
	int temp[1] = { 0 };
	int* dados[1] = { &temp[0] };
...
TEST(arvbin_visitar_em_ordem_inversa, ArvoreDoisElementosRaizDireita)
{
	struct arvbin arv;
	int temp[2] = { 0, 1 };
...
TEST(arvbin_visitar_em_ordem_inversa, ArvoreDoisElementosRaizEsquerda)
{
	struct arvbin arv;
	int temp[2] = { 1, 0 };
...
TEST(arvbin_visitar_em_ordem_inversa, ArvoreTresElementosRaizEsquerdaDireita)
{
	struct arvbin arv;
	int temp[3] = { 1, 0, 2 };
	int* dados[3] = { &temp[0], &temp[1], &temp[2] };
	struct arvbin_no* nos[sizeof(dados)/sizeof(int*)];
	int* visitas[3] = { &temp[2], &temp[0], &temp[1] };
...
TEST(arvbin_visitar_em_ordem_inversa, ArvoreTresElementosRaizDireitaDireita)
{
	struct arvbin arv;
	int temp[3] = { 0, 1, 2 };
...
TEST(arvbin_visitar_em_ordem_inversa, ArvoreTresElementosRaizDireitaEsquerda)
{
	struct arvbin arv;
	int temp[3] = { 0, 2, 1 };
...
TEST(arvbin_visitar_em_ordem_inversa, ArvoreTresElementosRaizEsquerdaEsquerda)
{
	struct arvbin arv;
	int temp[3] = { 2, 1, 0 };
...
TEST(arvbin_visitar_em_ordem_inversa, ArvoreTresElementosRaizEsquerdaDireita2)
{
	struct arvbin arv;
	int temp[3] = { 2, 0, 1 };
